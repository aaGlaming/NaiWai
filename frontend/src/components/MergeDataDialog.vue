...
<template>
  <div class="fixed inset-0 z-[120] flex items-center justify-center p-6 bg-ink/70">
    <div class="max-w-md w-full bg-paper p-8 border border-ink/15" role="dialog" aria-labelledby="merge-title">
